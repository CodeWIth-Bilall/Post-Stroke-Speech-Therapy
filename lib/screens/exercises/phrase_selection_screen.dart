...
import 'session_practice_screen.dart';

class PhraseSelectionScreen extends StatefulWidget {
  final bool embedded;
  const PhraseSelectionScreen({super.key, this.embedded = false});

  @override
  State<PhraseSelectionScreen> createState() => _PhraseSelectionScreenState();
}

class _PhraseSelectionScreenState extends State<PhraseSelectionScreen> {
  ...
  Widget build(BuildContext context) {
    return widget.embedded ? _buildBody(context) : Scaffold(
      backgroundColor: AppTheme.scaffoldBg,
      appBar: AppBar(
        title: const Text('Practice Phrases'),
  ...
  Widget _buildBody(BuildContext context) {
    return Column(
      children: [
            ...
            child: Column(
              ...
              children: [
                ...
                ...AppConstants.phraseCategories.entries.map((entry) {
                  return _buildCategoryDropdown(context, entry.key, entry.value);
                }),
              ],
            ),
          ),
        ...
        // Bottom action bar — only when phrases are selected
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      label: Text('Start Session (${_selectedPhrases.length} phrases × ${_repetitions}x)',
  ...
  Widget _buildCategoryDropdown(BuildContext context, String category, List<String> phrases) {
            ...
            Wrap(
              ...
              children: phrases.map((phrase) {
                ...
                return GestureDetector(
                  ...
                  onLongPress: () {
                    Navigator.push(context, MaterialPageRoute(
                      builder: (_) => PhrasePracticeScreen(phrase: phrase, category: category),
                    ));
                  },
